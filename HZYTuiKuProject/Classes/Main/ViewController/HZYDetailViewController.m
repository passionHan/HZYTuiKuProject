...
@interface HZYDetailViewController ()<UIWebViewDelegate>
...
@property (nonatomic,strong) HZYDetailModel *webModel;
...
-(void)setDetailTextId:(NSString *)detailTextId{
    ...
    [HZYDetailModel detileNewsModelGetWithdetailTextId:detailTextId success:^(HZYDetailModel *model) {
...
-(NSString *)getImageWith:(NSString *)contensHtmlString imageArray:(NSArray *)images{
    ...
    for (int i = 0; i < num.count; i++) {
        ...
        for (HZYImageModel *imageModel in images) {
