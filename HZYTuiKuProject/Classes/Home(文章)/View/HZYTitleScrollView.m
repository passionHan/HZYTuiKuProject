...
@implementation HZYTitleScrollView
...
-(void)setTitleModelArray:(NSArray *)titleModelArray{
    ...
    for (int i = 0; i < titleModelArray.count; i ++) {
        ...
        HZYTitleModel *model = titleModelArray[i];
        ...
        [button setTitleColor:HZYColor(22.0, 147.0, 114.0) forState:UIControlStateSelected];
